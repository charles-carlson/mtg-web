...
export const file_cards: GenFile = /*@__PURE__*/
  fileDesc("");
...
export type SearchCardsRequest = Message<"cards.SearchCardsRequest"> & {
  ...
  /**
   * @generated from field: cards.SortBy sort_by = 7;
   */
  sortBy: SortBy;
};
...
/**
 * @generated from enum cards.SortBy
 */
export enum SortBy {
  /**
  ...
  /**
   * @generated from enum value: PRICE_ASC = 3;
   */
  PRICE_ASC = 3,

  /**
   * @generated from enum value: PRICE_DESC = 4;
   */
  PRICE_DESC = 4,
}

/**
 * Describes the enum cards.SortBy.
 */
export const SortBySchema: GenEnum<SortBy> = /*@__PURE__*/
  enumDesc(file_cards, 0);
